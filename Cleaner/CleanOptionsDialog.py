...
class CleanOptionsDialog(QDialog):
    def __init__(self, json_file):
        ...
        self.main_layout = QVBoxLayout(
            self
        )  # Créez et assignez un QVBoxLayout à la dialog
    ...
    def build_form(self, config_data):
        for category, data in config_data["Configurations"].items():
            ...
            grid_layout = QGridLayout(
                group_box
            )  # Créez et assignez un QGridLayout au group_box
            ...
            for key, option in data["options"].items():
                ...
                grid_layout.addWidget(
                    check_box, row, col
                )  # Ajoutez check_box au grid_layout
                ...
                if (
                    col > 1
                ):  # Si vous avez rempli deux colonnes, réinitialisez pour la nouvelle ligne
                    col = 0
                    row += 1
