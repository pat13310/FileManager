...
################################################################################
## Form generated from reading UI file 'FileManagereDfaEj.ui'
##
...
class Ui_FileManager(object):
    def setupUi(self, FileManager):
        ...
        self.panel_treeview.setMinimumSize(QSize(320, 0))
        self.panel_treeview.setMaximumSize(QSize(420, 16777215))
...
"color: black;")
        ...
        self.panel_listview.setMinimumSize(QSize(400, 0))
        self.panel_listview.setMaximumSize(QSize(420, 16777215))
        ...
        self.scrollAreaContents.setGeometry(QRect(0, 0, 464, 553))
